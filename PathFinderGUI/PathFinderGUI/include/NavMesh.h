...
class NavMesh
{
  public:
    ...
    ngl::Vec3 getClosestNavMeshPosition(ngl::Vec3 _point);
    size_t getClosestNavMeshWayIndex(ngl::Vec3 _point);

    void extractNavMeshTrianglePoints();
    size_t numTriangles();
  ...
  private:
    ...
    std::vector<ngl::Vec3> m_meshPoints;
    std::vector<ngl::Vec3> m_meshColours;
